...
import { Plus, Search, Clock, CheckCircle, XCircle, X, ArrowLeftRight } from "lucide-react";
import { AppShell } from "@/components/layout/AppShell";
import { useInventoryItems } from "@/hooks/useInventory";
import { useAuth } from "@/hooks/useAuth";
import {
  getBorrowRecords, createBorrowRequest,
...
export default function BorrowPage() {
  ...
  const { data: records = [], isLoading } = useQuery({
    ...
    queryFn: () => getBorrowRecords(tab === "all" ? undefined : tab),
  });
  ...
  // Tomorrow as min date for return date
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                >
                  {createMut.isPending ? "กำลังส่ง..." : "ส่งคำขอยืม"}
                </button>
              </div>
            </motion.div>
          </motion.div>
